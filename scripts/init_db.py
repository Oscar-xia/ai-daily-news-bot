...
# 90 个精选 RSS 源（来自 ai-daily-digest，基于 Karpathy 推荐的 HN 顶级技术博客）
DEFAULT_RSS_SOURCES = [
    # 官方博客 & 技术领袖
...
async def insert_default_sources():
    """Insert default RSS sources (90 curated feeds)."""
    print(f"Inserting {len(DEFAULT_RSS_SOURCES)} default RSS sources...")
...
async def main():
    ...
    print("=" * 60)
    print("AI Daily News Bot - Database Initialization (v2.0)")
    print("=" * 60)
    print()
    ...
    print(f"  Default sources: {len(DEFAULT_RSS_SOURCES)}")
    print("=" * 60)
